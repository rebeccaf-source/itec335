...
public static Collection<Object[]>  testdata() {
   return Arrays.asList(new Object[][] {
      ...
      { "T3.1", 15, true, ParkSales.Rate.FREE},
      { "T3.2", 40, true, ParkSales.Rate.FREE},
      { "T3.3", 90, true, ParkSales.Rate.FREE},
      
      //Statement Coverage Tests
      { "T4.1", 8, false, ParkSales.Rate.KID},
      
      //Add Branch Coverage Tests here
      { "T5.1", -10, true, ParkSales.Rate.ERROR},
